...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpc_5fmeta_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::myRPC::RpcMeta, service_id_),
  PROTOBUF_FIELD_OFFSET(::myRPC::RpcMeta, method_id_),
...
const char descriptor_table_protodef_rpc_5fmeta_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016rpc_meta.proto\022\005myRPC\"C\n\007RpcMeta\022\022\n\nse"
  "rvice_id\030\001 \001(\t\022\021\n\tmethod_id\030\002 \001(\t\022\021\n\tdat"
  "a_size\030\003 \001(\005b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpc_5fmeta_2eproto = {
  false, false, descriptor_table_protodef_rpc_5fmeta_2eproto, "rpc_meta.proto", 100,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "myRPC.RpcMeta.service_id"));
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "myRPC.RpcMeta.method_id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 data_size = 3;
