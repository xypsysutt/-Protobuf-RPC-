...
namespace myRPC {
            ...
            const boost::shared_ptr<boost::asio::ip::tcp::socket>& socket)
        {
            ...
            auto done = google::protobuf::NewCallback(
                this, &RpcServerImpl::OnCallbackDone, resp_msg, socket); //(object,void(*function)(arg1,arg2),arg1 x1,arg2 x2)
        ...
        void RpcServerImpl::OnCallbackDone(::google::protobuf::Message* resp_msg,
            const boost::shared_ptr<boost::asio::ip::tcp::socket> socket)
        {
            int serialized_size = resp_msg->ByteSizeLong();
